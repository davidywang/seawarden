...
master_Feeding_Prep <- read.csv(paste0(master_files, 'master_RAC-bream - Feeding_Prep.csv'), header=TRUE, sep=",")
master_Population_Prep <- read.csv(paste0(master_files, 'master_RAC-bream - Population_Prep.csv'), header=FALSE, sep=",")

#files for final model run
master_Population <- read.csv(paste0(master_files, 'master_RAC-bream - Population.csv'), header=FALSE, sep=",")
master_Parameters <- read.csv(paste0(master_files, 'master_RAC-bream - Parameters.csv'), header=FALSE, sep=",")

#files for both steps
master_Management <- read.csv(paste0(master_files, 'master_RAC-bream - Management.csv'), header=FALSE, sep=",")
master_Food <- read.csv(paste0(master_files, 'master_RAC-bream - Food_Characterization.csv'), header=FALSE, sep=",")
```
