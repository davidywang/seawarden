...
bream_folder <- "/Users/Zack/0_seawarden/r_rac/rac_bream/"
site_folder_bream <- '/Bream_population/Outputs/Out_csv/'

bass_folder <- "/Users/Zack/0_seawarden/r_rac/rac_seabass/"
...
```{r}
for (i in sites){
  compiler(bream_folder, site_folder_bream, i, .7)
  compiler(bass_folder, site_folder_bass, i, .95)} #sebass
```
