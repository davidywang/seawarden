...
#v_18 <- '/Users/Zack/0_thesis_ocean_current_2/vo_2018_tif/' #or 2018
#u_18 <- '/Users/Zack/0_thesis_ocean_current_2/uo_2018_tif/' #or 2018
...
#output_18 <- '/Users/Zack/0_thesis_ocean_current_2/current_2018_csv/' #for 2018
output_19 <- '/Users/Zack/0_thesis_ocean_current_2/current_2019_csv/' #for 2019

#output folder - for combine
#output_csv <- '/Users/Zack/0_thesis_ocean_current_2/current_csv/'
```
...
current_tool <- function(v_folder, u_folder, target, output){ 
  ...
  filename <- paste0(output, paste0(df['farm_id']), '_current.csv')
...
#for (i in sites){current_tool(v_18, u_18, targets[i,], output_18)}
for (i in sites){current_tool(v_19, u_19, targets[i,], output_19)}
```
