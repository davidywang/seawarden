...
```{r}
#process SST for all farm sites

#load sst data
tif_folder <- '/Users/Zack/0_thesis_sst/ghrsst_2019_tif/'

#output folder
csv_output <- '/Users/Zack/0_thesis_sst/ghrsst_2019_csv_multi/'
...
# for (i in 1:10){
# for (i in 1:nrow(as.data.frame(targets))){sst_tool(tif_folder, targets[i,], csv_output)}
...
#parallel process
foreach(i = 1:nrow(as.data.frame(targets))) %dopar% sst_tool(tif_folder, targets[i,], csv_output)
